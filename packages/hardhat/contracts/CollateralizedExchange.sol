...
/**
 * Enables two parties to exchange anything by collateralizing each side to safe guard against discoordination 
 */
contract CollateralizedExchange {
    ...
    ** required to be locked by the item they are purchasing
    */
